...
//
void  CSHA256::WriteBE64(unsigned char* ptr, uint64_t x)
{
    uint64_t v = htobe64(x);
    memcpy(ptr, (char*)&v, 8);
}

void CSHA256::WriteBE32(unsigned char* ptr, uint32_t x)
{
    uint32_t v = htobe32(x);
    memcpy(ptr, (char*)&v, 4);
}
uint32_t CSHA256::ReadBE32(const unsigned char* ptr)
{
    uint32_t x;
    memcpy((char*)&x, ptr, 4);
    return be32toh(x);
...
uint64_t CSHA256::ReadBE64(const unsigned char* ptr)
{
    uint64_t x;
    memcpy((char*)&x, ptr, 8);
    return be64toh(x);
...
void CSHA256::Initialize(uint32_t* s)
{
    s[0] = 0x6a09e667ul;
    s[1] = 0xbb67ae85ul;
    s[2] = 0x3c6ef372ul;
...
void CSHA256::Transform(uint32_t* s, const unsigned char* chunk, size_t blocks)
{
    while (blocks--) {
...
void CSHA256::TransformD64(unsigned char* out, const unsigned char* in)
{
    // Transform 1
